...
- [nodejs](https://nodejs.org/en/) (I've used version `14.17.6` while writing this doc)
- NPM (I've used version `6.14.15` while writing this doc)
- [Google Chrome](https://www.google.com/intl/en_us/chrome/) (I've used version `97.0.4692.71` while writing this doc)
